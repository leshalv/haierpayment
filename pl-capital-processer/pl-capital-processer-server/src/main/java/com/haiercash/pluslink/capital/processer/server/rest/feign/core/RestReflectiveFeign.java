/*
package com.haiercash.pluslink.capital.processer.server.rest.feign.core;
...
/**
    ...
    private static class BuildTemplateByResolvingArgs implements FeignRequest.Factory {
        private static final Method RESOLVE = ReflectionUtils.getMethod(RequestTemplate.class, "resolve", new Class<?>[]{Map.class, Map.class}, false);
