...
--入账事务表(PL110)
--应用ID
insert into PL_DICTIONARY_SUB (ID, DICTIONARY_ID, SUB_NAME, SUB_VALUE, SUB_ORDER, CREATE_BY, CREATE_DATE, DEL_FLAG) values ('PL1101_1', 'PL1101', '资金平台', 'plr', 1, 'SYSTEM', SYSDATE, 'NORMAL');
--入账状态
...
--辅助类型
insert into PL_DICTIONARY_SUB (ID, DICTIONARY_ID, SUB_NAME, SUB_VALUE, SUB_ORDER, CREATE_BY, CREATE_DATE, DEL_FLAG) values ('PL1203_1', 'PL1203', '支付渠道，存放同业', '0011', 1, 'SYSTEM', SYSDATE, 'NORMAL');
insert into PL_DICTIONARY_SUB (ID, DICTIONARY_ID, SUB_NAME, SUB_VALUE, SUB_ORDER, CREATE_BY, CREATE_DATE, DEL_FLAG) values ('PL1203_2', 'PL1203', '支付供应商', '0019', 2, 'SYSTEM', SYSDATE, 'NORMAL');
insert into PL_DICTIONARY_SUB (ID, DICTIONARY_ID, SUB_NAME, SUB_VALUE, SUB_ORDER, CREATE_BY, CREATE_DATE, DEL_FLAG) values ('PL1203_3', 'PL1203', '联合项目辅助', '0006', 3, 'SYSTEM', SYSDATE, 'NORMAL');
--支付工具
